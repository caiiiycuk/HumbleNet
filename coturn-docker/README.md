...
| 49152–49252 | UDP | Media relay range (configurable) |
...
- **Session limits**: Per-user quota of 12 concurrent allocations, 100 total
...
- Ensure UDP ports 49152–49252 are open on both host firewall and cloud firewall
